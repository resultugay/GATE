...
def eval_classifier_and_retrieve_topK(sentence_pairs, config, model, lm='distilbert', max_len=256):
    ...
    print("=============%s==================" % taskname)
    log.logger.info(r"===============taskname:{} =================".format(taskname))
    ...
    if num_classes <= 2:
        ...
        print("f1=%.3f" % f1)
        print("======================================")
        log.logger.info(r"accuracy={}".format(accuracy))
        log.logger.info(r"precision={}".format(precision))
        log.logger.info(r"recall={}".format(recall))
        log.logger.info(r"f1={}".format(f1))
        log.logger.info("===================================")
        ...
        print("======================================")
        log.logger.info(r"accuracy={}".format(accuracy))
        log.logger.info(r"macro_f1={}".format(f1))
        log.logger.info		("===================================")

    t2 = time.time()
    print("test time:" + str(t2 - t1))
    log.logger.info	(r"test time:{}".format(str(t2 - t1)))
...
def run_train(run_id=0):
    ...
    config = {'name': 'ditto', 'task_type': 'classification', 'vocab': ['0', '1', '2'],
              'trainset': 'data/sics_literature_matcher_cleaned/train.txt',
              'validset': 'data/sics_literature_matcher_cleaned/val.txt',
              'testset': 'data/sics_literature_matcher_cleaned/test.txt'}
...
for iter_id in range(iteration):
    ...
    log.logger.info(r"**** active learning iteration: {}, accuracy={}".format(str(iter_id), str(r3)))
